...
static const char *fwfn = "/fcfw.bin";     //"/fc-DMX.ino.nodemcu-32s.bin";
static const char *fwfnold = "/fcfw.old";  //"/fc-DMX.ino.nodemcu-32s.old";
...
static bool firmware_update()
{
    ...
    Serial.println("Firmware_update in progress...");
