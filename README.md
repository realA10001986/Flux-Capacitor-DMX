...
If DMX_USE_VERIFY is defined in fc_global.h (which it is by default), a DMX packet verifier is implemented. Channel 46 must be at value 100, otherwise the DMX packet is ignored.
